...
# This is a rewriting of all of the specifications that the project description provides,
...
test_btree_properties_even()
print ("test_btree_properties_even() pass")
...
def test_btree_properties_odd() -> None:
    ...
    root_addr = btree.root_addr
    btree_properties_recurse(root_addr, DISK.read(root_addr), M, L)
test_btree_properties_odd()
print ("test_btree_properties_odd() pass")
...
test_insert_and_find_odd()
print ("test_insert_and_find_odd() pass")
...
test_insert_and_find_even()
print ("test_insert_and_find_even() pass")
...
test_insert_and_find_edge()
print ("test_insert_and_find_edge pass")
def test_other_datatypes():
    ...
    assert btree.find("1") == "1"
test_other_datatypes()
print ("test_other_datatypes pass")