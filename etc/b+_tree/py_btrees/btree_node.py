...
class BTreeNode(Generic[KT, VT]):
    def __init__(self, my_addr: Address, parent_addr: Optional[Address], index_in_parent: Optional[int], is_leaf: bool):
        ...
        * is_leaf keeps track of if this node is a leaf n
        ode or not.
    ...
    def insert_key(self,key,child1,child2):
        idx=self.find_idx(key)
        self.keys.insert(idx, key)
        self.children_addrs[idx]=child1
        self.children_addrs.insert(idx+1,child2)
        return idx
